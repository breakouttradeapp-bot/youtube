...
class SeoResultActivity : AppCompatActivity() {
    ...
    private fun bindContent(seo: SeoContent) {
        ...
        binding.btnCopyTitle.setOnClickListener {
            if (seo.title.isNotEmpty())
                copyToClipboard("Title", seo.title)
            else
        ...
        binding.btnCopyDesc.setOnClickListener {
            if (seo.description.isNotEmpty())
                copyToClipboard("Description", seo.description)
            else
                Toast.makeText(this, "Nothing to copy", Toast.LENGTH_SHORT).show()
        }
        ...
        binding.btnCopyHashtags.setOnClickListener {
            if (seo.hashtags.isNotEmpty())
                copyToClipboard("Hashtags", seo.hashtags)
            else
                Toast.makeText(this, "Nothing to copy", Toast.LENGTH_SHORT).show()
        }
